...
set.seed(1234)
tau=365
source("EX_figure_source.R")
MI_result_365<-MI_impute()
...
rbind(beta_model_results_EM,pi_model_results_EM,beta_model_results_MI,pi_model_results_MI,RMST_model_results)
